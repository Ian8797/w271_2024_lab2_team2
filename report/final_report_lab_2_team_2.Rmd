...
poly_resid_plot <- ggplot(poly_residual_data, aes(x = predicted_values, y = residuals)) +
  ...
  geom_hline(yintercept = 0, linetype = "dashed", color = "red") +
  geom_smooth(se = FALSE, formula = y ~ x, method = "loess") +
  labs(title = "Seasonal Polynomial Model (3)", 
       x = "Fitted Values", y = "")
...
```{r EDA PART 2,fig.width = 6, fig.height = 3, echo=FALSE, warning=FALSE, message=FALSE, fig.align='center'}
# Distribution 
...
```{r Task 5b STL, echo = FALSE, warning=FALSE, fig.width = 6, fig.height = 3, fig.align='center'}
...
```{r SARIMA model selection 2, warning=FALSE, echo = FALSE, fig.width = 6, fig.height = 4, fig.align='center'}
SARIMA.model |>
  gg_tsresiduals() +
...
```{r forecast out to year 2122, echo = FALSE, warning=FALSE, fig.width = 6, fig.height = 3, fig.align='center'}
