...
time_series + acf + pacf + plot_annotation(expression(italic('Figure 3. Time Series, ACF, and PACF After First Difference')), theme=theme(plot.title=element_text(hjust=0.5)))
```
...
We used the models from equations 3 and 6 to generate forecasts of the expected atmospheric CO2 concentrations over the next 20 years. These forecasts are shown in Figure 4 below.

**insert plot**

The forecasts generated by each model are similar in nature and both support that the trend and seasonal patterns present in the CO2 data will persist into the future. 
